...
public:
    ...
    void sendActivated(const QString& name);
...
private Q_SLOTS:
    void handleUnregisterShortcut(uid_t uid, const QString& name);
    void handleBindKeySequence(uid_t uid, const QString& name, const QKeySequence& keySequence, uint action);
    void handleBindSwipeGesture(uid_t uid, const QString& name, uint finger, uint direction, uint action);
    void handleBindHoldGesture(uid_t uid, const QString& name, uint finger, uint action);
    void handleCommit(uid_t uid);
